  ...
  return (
    <main className="flex flex-col items-center">
      ...
      <div className="h-screen main-div">
        ...
        <div className="flex flex-row justify-between headliner-container">
          ...
          <div className="headliner-container-20 flex flex-col justify-end">
            <p>
            I am a programmer with a knack for creating interactive and seamless software solutions. I’ve got a knack for design and an interest in creating engaging user experiences.
            </p>
          </div>

        </div>
        <div className="flex flex-row items-start justify-between ig-grid-container">
          <Carousel/>
        </div>
      </div>
    </main>
